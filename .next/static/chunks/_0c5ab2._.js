(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_0c5ab2._.js", {
...
const Profile = ({ setShowProfile, onEdit })=>{
    ...
    }["Profile.useEffect"], []); // Re-run when `user` changes
    const onClick = ()=>{
    ...
    const handleUpdateProfile = async ()=>{
        ...
        try {
            ...
            const updatedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$dfc2d82f$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__o__as__getAuth$3e$__["getAuth"])().currentUser; // Get the latest user data
            setUser(updatedUser);
        } catch (error) {
...
const InternshipFilters = ()=>{
    ...
    const fetchInternships = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:5000/internships", {
                params: filters
            });
...
_s(InternshipFilters, "ySFqR4pXwEc/cXgBH7QWdP5RHX4=");
...
//# sourceMappingURL=_0c5ab2._.js.map